#!/bin/bash
rowstart=6
export LEGACY_SURVEY_DIR=/global/cscratch1/sd/huikong/obiwan_Aug/repos_for_docker/obiwan_data/legacysurveydir_dr8
...
#PYTHONPATH
export PYTHONPATH=$CSCRATCH_OBIWAN/obiwan_code/legacypipe/py:$CSCRATCH_OBIWAN/obiwan_code/py:/usr/local/lib/python:/usr/local/lib/python3.6/dist-packages:.:${UNWISE_PSF_DIR}/py
...
--checkpoint ${outdir}/checkpoints/${bri}/${brick}/${rsdir}/checkpoint-${brick}.pickle \
